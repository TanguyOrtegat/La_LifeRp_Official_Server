            ...
            if myjob == 4 then
                while true do
                  ...
                  if isMine == true then
                   ...
                   elseif tonumber(inv_qty) < 30 and chance_mat >= 500 and chance_mat < 2000 then
                       ShowMsgtime.msg = 'En train de miner...'
                       ShowMsgtime.time = 250
                       TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                       Wait(2500)
                   ...
                   elseif tonumber(inv_qty) < 30 and chance_mat >= 2000 and chance_mat < 2499 then
                       ShowMsgtime.msg = 'En train de miner...'
                       ShowMsgtime.time = 250
                       TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                       Wait(2500)
                   ...
                   elseif tonumber(inv_qty) < 30 and chance_mat >= 2499 and chance_mat <= 2500 then
                       ShowMsgtime.msg = 'En train de miner...'
                       ShowMsgtime.time = 250
                       TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                       Wait(2500)
                ...
                while true do
                  ...
                  if isSell == true then
                    ...
                    elseif tonumber(ITEMSJOB[21].quantity) > 0 then
                      ...
                      Wait(2500)
                      --local price = math.ceil(PriceBourse)
                      ShowMsgtime.msg = '~r~-1 fer traité ~w~/ ~g~+' .. 80 .. '$'
                      ShowMsgtime.time = 150
                      TriggerEvent("inventory:sell",0, 1, 21, 80, "")
                      Wait(2000)
                    else
                ...
                while true do
                  ...
                  if isSellDiams == true then
                    ...
                    if tonumber(ITEMSJOB[22].quantity) > 0 then
                      ...
                      Wait(2500)
                      --local price = math.ceil(PriceBourse)
                      ShowMsgtime.msg = '~r~-1 diamant traité ~w~/ ~g~+' .. 900 .. '$'
                      ShowMsgtime.time = 150
                      TriggerEvent("inventory:sell",0, 1, 22, 900, "")
                      Wait(2000)
                    else
                      TriggerEvent("itinerance:notif", "~r~Vous n'avez pas de minerais traités sur vous !")
                      isSellDiams = false
