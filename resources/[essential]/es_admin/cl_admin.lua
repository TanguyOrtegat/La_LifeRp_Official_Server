...
RegisterNetEvent('es_admin:loadpropsweed')
AddEventHandler('es_admin:loadpropsweed', function(loadprops)
        local hash = GetInteriorFromEntity(GetPlayerPed(-1))
		--Citizen.Trace(hash)
        EnableInteriorProp(tonumber(247297),loadprops)
        RefreshInterior(tonumber(247297))
end)
