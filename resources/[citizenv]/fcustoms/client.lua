...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
emplacement_customs = {
	{locked = false,name="LS Customs", colour=7, id=72, locked = false, outside = { x = -362.7962, y = -132.4005, z = 38.25239, heading = 71.187133}, inside = {x = -337.3863,y = -136.9247,z = 38.5737, heading = 269.455}, owner = 30,emp = 31},
	{locked = false,name="LS Customs", colour=7, id=72, locked = false, outside = { x = -1140.191, y = -1985.478, z = 12.72923, heading = 315.290466}, inside = {x = -1155.536,y = -2007.183,z = 12.744, heading = 155.413}, owner = 32,emp = 33},
	{locked = false,name="LS Customs", colour=7, id=72, locked = false, outside = { x = 716.4645, y = -1088.869, z = 21.92979, heading = 88.768}, inside = {x = 731.8163,y = -1088.822,z = 21.733, heading = 269.318}, owner = 34,emp = 35},
	{locked = false,name="LS Customs", colour=7, id=72, locked = false, outside = { x = 1174.811, y = 2649.954, z = 37.37151, heading = 0.450}, inside = {x = 1175.04,y = 2640.216,z = 37.32177, heading = 182.402}, owner = 36,emp = 37},
	{locked = false,name="LS Customs", colour=7, id=72, locked = false, outside = { x = 111.366714477539, y = 6625.84033203125, z = 31.7872333526611, heading = 269}, inside = {x = 111.366714477539, y = 6625.84033203125, z = 31.7872333526611, heading = 71}, owner = 38,emp = 39},
}
        ...
        for k,v in ipairs(emplacement_customs) do
            if(Vdist(pos.x, pos.y, pos.z, v.outside.x, v.outside.y, v.outside.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.outside.x, v.outside.y, v.outside.z) < 5.0)then
                    ...
                    if (v.locked == false and v.owner == User.job or v.emp == User.job) then
