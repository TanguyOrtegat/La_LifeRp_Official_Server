...
OUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTS
OUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTSOUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTS
OUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTSOUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTS
OUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTSOUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTS
OUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTSOUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTS
OUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTSOUBLIE PAS D'ALLER TE FAIRE ENCULER SI TU ESSAI DE VOLER LES SCRIPTS
...
function getMainMenu()
    ...
    if tonumber(User.job) == 56 then
      VMenu.AddFunc(98, "Menu Pecheur", "menupeche:menuOG", {User.job}, lang.common.access)
    end
    ...
    VMenu.AddFunc(98, "Menu Redneck", "menuweed:menuOG", {User.subjob}, lang.common.access)
        ...
        VMenu.AddFunc(98, "Mettre/Enlever le casque", "vmenu:switchCasque", {}, lang.common.access)
...
RegisterNetEvent("vmenu:switchCasque")
AddEventHandler("vmenu:switchCasque", function()
  if isHaveCasque then
      TriggerServerEvent("casqueshop:reloadOutfits_s2")
      isHaveCasque = false
  else
      TriggerServerEvent("casqueshop:reloadOutfits_s")
      isHaveCasque = true
  end
end)
